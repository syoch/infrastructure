"""Small self-contained helpers for the standalone device agent.

Kept local (not imported from the backend) so this package has no backend
dependency and can be shipped to devices on its own.
"""
import json
import urllib.error
